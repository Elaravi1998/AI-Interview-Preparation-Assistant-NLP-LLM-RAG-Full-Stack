...
export const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setError('Registration failed. Please verify input details.');
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/30 via-slate-950 to-slate-950">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Create AI Account</h1>
          <p className="text-sm text-slate-400">Start your candidate interview preparation journey</p>
        </div>
